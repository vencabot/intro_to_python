...
class PaletteEditor:
    ...
    def initCharPalClasses(self, f):
        self.palettes["Alex"] = charPalettes(f, ALEX_PAL_ADDR, 7, "Alex")
        self.palettes["Ryu"] = charPalettes(f, RYU_PAL_ADDR, 7, "Ryu")
        self.palettes["Yun"] = charPalettes(f, YUN_PAL_ADDR, 7, "Yun")
        self.palettes["Dudley"] = charPalettes(f, DUD_PAL_ADDR, 7, "Dudley")
        self.palettes["Necro"] = charPalettes(f, NECRO_PAL_ADDR, 7, "Necro")
        self.palettes["Hugo"] = charPalettes(f, HUGO_PAL_ADDR, 7, "Hugo")
        self.palettes["Ibuki"] = charPalettes(f, IBUKI_PAL_ADDR, 7, "Ibuki")
        self.palettes["Elena"] = charPalettes(f, ELENA_PAL_ADDR, 7, "Elena")
        self.palettes["Oro"] = charPalettes(f, ORO_PAL_ADDR, 7, "Oro")
        self.palettes["Yang"] = charPalettes(f, YANG_PAL_ADDR, 7, "Yang")
        self.palettes["Ken"] = charPalettes(f, KEN_PAL_ADDR, 7, "Ken")
        self.palettes["Sean"] = charPalettes(f, SEAN_PAL_ADDR, 7, "Sean")
        self.palettes["Urien"] = charPalettes(f, URIEN_PAL_ADDR, 7, "Urien")
        self.palettes["Gouki"] = charPalettes(f, GOUKI_PAL_ADDR, 7, "Gouki")
        self.palettes["Shin Gouki"] = charPalettes(f, SHING_PAL_ADDR, 2, "Shin Gouki")
        self.palettes["Chun Li"] = charPalettes(f, CHUN_PAL_ADDR, 7, "Chun Li")
        self.palettes["Makoto"] = charPalettes(f, MAK_PAL_ADDR, 7, "Makoto")
        self.palettes["Q"] = charPalettes(f, Q_PAL_ADDR, 7, "Q")
        self.palettes["Twelve"] = charPalettes(f, TWELVE_PAL_ADDR, 7, "Twelve")
        self.palettes["Remy"] = charPalettes(f, REMY_PAL_ADDR, 7, "Remy")
        
    def testClasses(self):
        print(self.palettes["Alex"].charName)
...
buttonTestCalc = Button(root, text="Test Calc", command=palette_editor.testClasses)
buttonTestCalc.pack()
